    ...
    return (
        <div data-aos="fade-down" className=' w-full    '>
            <div className='flex  w-full  items-center h-screen'>
                <div
                    className='min-w-[320px] sm:min-w-[400px] px-4 w-full py-8 text-center items-center bg-black  rounded-xl border-2 backdrop-opacity-[.15]'>
                    ...
                    <h2 className='flex justify-center text-lime-300 font-mono text-xl shadow-md shadow-white py-2'>Sign
                        Up </h2>
                    <input
                        className='bg-transparent border-2 text-white placeholder:text-white my-3 py-1 px-2 rounded-lg outline-0 shadow-sm shadow-white '
