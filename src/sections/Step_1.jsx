        ...
        <div className='w-[90%] m-auto'>
            <div className=''>
                ...
                <div className='flex justify-center my-4'>
                    <button className='border border-slate-500 rounded-lg text-slate-400 px-4 py-2 hover:text-white duration-200 hover:shadow-white hover:shadow-sm'>View Avaliable Sources</button>
                </div>
...
<div className='flex justify-center'>
    <img className=' w-full  pho:block lg:hidden' src={Screen} alt=""/>
                      ...
                      <div className='pho:flex flex-wrap pho:justify-center lg:block'>
                          <h3 className='lg:text-[50px] font-semibold lg:w-[450px] pho:text-[30px] lg:mt-20 '>Your Content.</h3>
                          <h3 className='lg:text-[50px] font-semibold pho:text-[30px]'> All in  <span className='text-blue-500'>One Spot</span></h3>
                      </div>
                       <div className='flex   pho:justify-center lg:justify-start items-center gap-2 mt-10'> <p className='bg-slate-800 w-[26px] flex justify-center rounded-[13px] my-2 '>1</p> <p>Bring all of your content together into one homepage.</p></div>
                        <div className='flex pho:justify-center lg:justify-start items-center  gap-2'><p className='bg-slate-800 px-2 rounded-[13px] my-2 '>2</p> <p>Your page automatically updates whenever you create.</p></div>
