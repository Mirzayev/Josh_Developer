                ...
                <div className='flex lg:mt-[100px]'>
                    <div className='text-white'>
                        ...
                        <div data-aos=" zoom-in-up"
                             ...
                             className='flex   pho:justify-center lg:justify-start  items-center gap-2 mt-10'> <p className='bg-slate-800 w-[26px] flex justify-center rounded-[13px] my-2 '>1</p> <p>Embed content or create something new to share.</p></div>
                        <div data-aos="zoom-in-up" className='flex pho:justify-center lg:justify-start  items-center  gap-2'><p className='bg-slate-800 px-2 rounded-[13px] my-2 '>2</p> <p>Share content over email, text message or your homepage.</p></div>
